...
namespace tutorial.c
{
  public partial class Calculator
  {
    ...
    /// </summary>
    public interface IAsync : shared.d.SharedService.IAsync
    {
      /// <summary>
    ...
    /// and can optionally inherit from another service using the extends keyword.
    /// </summary>
    public class Client : shared.d.SharedService.Client, IAsync
    {
    ...
    public class AsyncProcessor : shared.d.SharedService.AsyncProcessor, ITAsyncProcessor
    {
